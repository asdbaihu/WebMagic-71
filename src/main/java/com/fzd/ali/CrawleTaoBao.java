 ...
 * Description:
 */
public class CrawleTaoBao {
    static String url = "https://shopsearch.taobao.com/search?app=shopsearch&q=%E5%A5%B3%E8%A3%85&js=1&initiative_id=staobaoz_20180509&ie=utf8";
...
//                break;
                ...
                if(result.contains("找到相关店铺")) {
                    System.out.println("1：" + result.contains("找到相关店铺"));
