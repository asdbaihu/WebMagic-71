...
public class TestCrawl {
    static String url = "https://s.1688.com/company/company_search.htm?keywords=%C5%AE%D7%B0&n=y&spm=a260k.635.3262836.d102&sug=1_0&smToken=5cbb6be67c9a4baa90637cacc5623a93&smSign=KHD0%2FLyRSynDa4tq9GTApw%3D%3D";
...
//                break;
                ...
                if(result.contains("宝贝与描述相符")) {
                    ...
                    System.out.println("3：" + "1688/淘宝会员（仅限会员名）请在此登录");
                }
                response.close();
                client.close();
            } catch (Exception e) {
